...
- [future/buddy-autonomous-agent-roadmap.md](future/buddy-autonomous-agent-roadmap.md)
  ...
  - 本文只记录还没完成的方向和验收口径；当前能力以代码、官方模板 JSON、Skill manifest 和测试为准。
...
- `docs/current_project_status.md`：当前状态快照不再维护；实现事实以代码、模板、Skill manifest 和测试为准。
...
- 代码、官方模板 JSON、Skill manifest 和测试是当前实现事实来源。
